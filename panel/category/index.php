                        ...
                        <tbody>
                            <?php
                                    global $pdo;
                                        ...
                                        if (!$categories){
                                            echo "<span class='badge bg-danger p-2 text-light'> There is not any category! </span> <br> <br> ";
                                            bye();
                                        }
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?=url("panel/category/delete.php?cat_id=$category->id") ?>" onclick=" return confirm('Are you sure to delete this category?') " class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
